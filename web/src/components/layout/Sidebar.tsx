...
import { LayoutDashboard, Thermometer, Egg, Cpu, Bell, Settings, Brain, X } from 'lucide-react';
...
export default function Sidebar({ isOnline, lastSeen, open = false, onNavigate }: SidebarProps) {
